...
import workImg2 from "../assets/projects/eatery-cafe.png";

const Work = () => {
  return (
    <div
      name="work"
      className="bg-custom-bg bg-noise-texture w-full md:h-screen text-gray-300 section"
    >
        ...
        <div className="grid sm:grid-cols-1 md:grid-cols-3 gap-4">
          ...
          >
            ...
            <div className="opacity-0 group-hover:opacity-100">
              ...
              <div className="pt-8 text-center">
                <a
                  href=" https://6657664ce7f8110d72ef4fcc--illustrious-hamster-e66259.netlify.app/"
                  target="_blank"
                >
                  <button className="text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg">
                    Demo
